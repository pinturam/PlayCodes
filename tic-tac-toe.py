...
def about():
    ...
    winl.config(text='Produced by Pintu Ram \n\n 04.10.2020')
    winl.mainloop()
...
menu_l.config(text='MENU', bg='grey', font="arial-13")
...
button_new_game.configure(bg='pink', activebackground='chartreuse3')
...
button_about.configure(bg='pink', activebackground='cornsilk1')
...
button_quit1.configure(bg='pink', activebackground='crimson')
